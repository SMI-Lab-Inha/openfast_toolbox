"""
Tools for OpenFAST linearization, that rely on openfast_toolbox
...
from openfast_toolbox.io import FASTInputDeck
from openfast_toolbox.case_generation.case_gen import templateReplace
